...
<body>
    <div class="workingArea">
        <h1 class="label label-info"><a style="font-size: 20px" href="admin_category_list">科室分类管理</a></h1>
                ...
                <tbody>
                    <c:forEach items="${allcategory}" var="c">
                        ...
                        <tr>
                            ...
                            <td><a href="admin_doctory_list?cid=${c.id}"><span class="glyphicon glyphicon-th-list"></span></a></td>
